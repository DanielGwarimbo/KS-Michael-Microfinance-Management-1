/*
  # Seed Sample Clients, Guarantors, and Loans

  1. Creates 5 sample clients with KYC data
  2. Creates guarantors for each client
  3. Creates sample loans in various states
  4. Creates sample repayments and accounting entries
*/
